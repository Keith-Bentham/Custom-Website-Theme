		 ...
		 <main id="content" class="col-sm-8">
			 ...
			 <div class="error-404 not-found">
				 ...
				 <div class="page-content">
					 ...
					 <h2>Dont fret! Lets get you back on track</h2>
					 
					 
					 <h3>Resources</h3>
					 <p>Perhaps you were looking for a paticular resource?</p>
...
<!-- 					    	<?php echo $resource_image; ?> -->
					 ...
					 <div class="widget wiget-categories">
				 ...
				 <?php the_widget( 'WP_Widget_Archives', 'title=Our Archive', 'before_title=<h4 class="widgettitle">&after_title=</h4>'); ?>
