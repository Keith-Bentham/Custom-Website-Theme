    	...
    	<article>
    		<div class="container clearfix">
    			<div class="row">
    				...
    				<div class="col-sm-5">
		    			<img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/agile.png" alt="Bootstrap to Wordpress" class="logo">
    				</div><!-- col -->
		    		...
		    		<div class="col-sm-7 hero-text">
			            ...
			            <div id="price-timeline">
			            	<div class="price active">
			            		<h4>Java MYSQL database GUI<small>Very soon!</small></h4>
			            		<span><?php echo $prelaunch_price; ?></span>
			            	</div><!-- end price -->
			            	
			            	<div class="price">
			            		<h4>Swift IOS messenger app<small>Coming soon!</small></h4>
			            		<span><?php echo $launch_price; ?></span>
			            	</div><!-- end price -->
			            	
			            	<div class="price">
			            		<h4>RESTful GUI application<small>Coming soon!</small></h4>
